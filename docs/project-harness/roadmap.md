...
P9-0A3a is durably closed. Coordinate `main`/`origin/main` are
`533ffcb1be17c6a26e8d5acf31e9c3c05da1ef63`; runner/job/runtime CLI ownership now
...
P9-0A4a is durably closed. Coordinate `main`/`origin/main` are
`4526d098ba4edcdcf669c41b6b6d827373088e5a`; receipt-aware completion CLI
ownership now lives in `completion_cli`. Exact evidence is in
[tasks/p9-0a4a-receipt-completion-cli/closeout.md](tasks/p9-0a4a-receipt-completion-cli/closeout.md).

P9-0A4b is durably closed. Coordinate `main`/`origin/main` are
`882c2a1487e4102d35c3c1f5b18b4a542be2d3bc`; workflow/assignment CLI ownership
now lives in `workflow_cli`, while receipt leaves remain in `completion_cli`. Exact
evidence is in
...
P9-0A6 is durably closed. Coordinate `main`/`origin/main` remain
...
the accepted decision is **no extraction** with named routing to later Phase 9
packages. Receipt `15e7d03f-43af-42ab-92cb-dfc5fc06c00b` is consumed. Exact evidence
is in [tasks/p9-0a6-post-closeout-module-review/closeout.md](tasks/p9-0a6-post-closeout-module-review/closeout.md).
