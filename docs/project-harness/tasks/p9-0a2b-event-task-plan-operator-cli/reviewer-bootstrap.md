# Reviewer Bootstrap: p9-0a2b-event-task-plan-operator-cli
...
cat openspec/changes/p9-0a2b-event-task-plan-operator-cli/proposal.md
# also review: design.md, specs/*/spec.md, tasks.md in that dir,
# and any docs/superpowers/plans/*-p9-0a2b-event-task-plan-operator-cli*.md implementation plan
```

Control-plane recorded the plan at `docs/project-harness/tasks/p9-0a2b-event-task-plan-operator-cli/plan.md` (server path, for reference only — read your LOCAL repo, not the server path). Do NOT switch branches, create worktrees, or modify any file — plan review is strictly read-only.
...
- **Source Plan**: openspec/changes/p9-0a2b-event-task-plan-operator-cli/proposal.md (relative; server copy: docs/project-harness/tasks/p9-0a2b-event-task-plan-operator-cli/plan.md)
