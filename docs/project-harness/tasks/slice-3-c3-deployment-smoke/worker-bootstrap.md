# Worker Bootstrap: slice-3-c3-deployment-smoke
...
Shared-worktree guard: this checkout may be used by other agents. If `pwd` is not `/Users/yinxin/projects/multinexus` or `git branch --show-current` is not `feature/multi-bot`, stop and report a blocker instead of switching branches.
...
```bash
cat /Users/yinxin/projects/multinexus/docs/project-harness/tasks/slice-3-c3-deployment-smoke/plan.md
```
...
- **Title**: S3-C3 deployment and real multi-host receipt smoke
- **Branch**: feature/multi-bot
- **Plan**: /Users/yinxin/projects/multinexus/docs/project-harness/tasks/slice-3-c3-deployment-smoke/plan.md
- **Phase**: approved
...
- **Start**: say you accepted `slice-3-c3-deployment-smoke` and list the 2-3 concrete steps you will do first.
...
task_id=slice-3-c3-deployment-smoke
...
```bash
assignment closeout discord-nexus --task-id slice-3-c3-deployment-smoke --reviewer <reviewer> \
...
- Primary: `/Users/yinxin/projects/multinexus` branch `feature/multi-bot`
...
3. For implementation tasks, run `assignment closeout discord-nexus --task-id slice-3-c3-deployment-smoke --reviewer <reviewer>`; do not mark your own implementation done
