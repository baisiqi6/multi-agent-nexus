...
```text
[agent-report] action=progress workspace_id=multinexus task_id=phase-5.4-workspace-doctor-harness-init summary="Completed <milestone>; tests: <result>; next: <next step>"
[agent-report] action=blocker workspace_id=multinexus task_id=phase-5.4-workspace-doctor-harness-init reason="Need <decision/input>"
[agent-report] action=done workspace_id=multinexus task_id=phase-5.4-workspace-doctor-harness-init summary="Implemented <scope>; tests: <result>; risks: <risk-or-none>"
```
