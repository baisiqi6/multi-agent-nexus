# Worker Bootstrap: phase-4-coordinator-integration
...
```bash
cat docs/project-harness/tasks/phase-4-coordinator-integration/plan.md
```
...
- **Task**: phase-4-coordinator-integration
- **Title**: Phase 4: Coordinator Integration (WebhookBus + system prompt)
- **Branch**: feature/multi-bot
- **Plan**: docs/project-harness/tasks/phase-4-coordinator-integration/plan.md
- **Phase**: approved
...
PYTHONPATH=src python3 -m multi_agent_coordinator --db /Users/yinxin/.multi-agent-coordinator/coordinator.sqlite3 <command> discord-nexus [options]
```
