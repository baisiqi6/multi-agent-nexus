# Worker Bootstrap: phase-5.5-discord-message-rendering
...
```bash
cat docs/project-harness/tasks/phase-5.5-discord-message-rendering/plan.md
```
...
- **Task**: phase-5.5-discord-message-rendering
- **Title**: Phase 5.5 Discord 消息渲染
- **Branch**: agents/mac-opencode/phase-5.5-discord-message-rendering
- **Plan**: docs/project-harness/tasks/phase-5.5-discord-message-rendering/plan.md
- **Phase**: approved
...
- **Start**: say you accepted `phase-5.5-discord-message-rendering` and list the 2-3 concrete steps you will do first.
...
task_id=phase-5.5-discord-message-rendering
