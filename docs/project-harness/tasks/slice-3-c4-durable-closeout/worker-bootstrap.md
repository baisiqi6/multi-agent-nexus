# Worker Bootstrap: slice-3-c4-durable-closeout
...
```bash
cat docs/project-harness/tasks/slice-3-c4-durable-closeout/plan.md
```
...
- **Task**: slice-3-c4-durable-closeout
- **Title**: S3-C4 Durable Slice 3 Closeout
- **Branch**: feature/multi-bot
- **Plan**: docs/project-harness/tasks/slice-3-c4-durable-closeout/plan.md
- **Phase**: approved
...
- **Start**: say you accepted `slice-3-c4-durable-closeout` and list the 2-3 concrete steps you will do first.
...
```bash
assignment closeout discord-nexus --task-id slice-3-c4-durable-closeout --reviewer <reviewer> \
...
3. For implementation tasks, run `assignment closeout discord-nexus --task-id slice-3-c4-durable-closeout --reviewer <reviewer>`; do not mark your own implementation done
