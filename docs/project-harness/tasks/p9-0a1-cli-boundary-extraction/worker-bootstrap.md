# Worker Bootstrap: p9-0a1-cli-boundary-extraction
...
Shared-worktree guard: this checkout may be used by other agents. If `pwd` is not `/Users/yinxin/projects/multinexus` or `git branch --show-current` is not `agents/mac-omp/p9-0a1-cli-boundary-extraction`, stop and report a blocker instead of switching branches.
...
```bash
cat docs/project-harness/tasks/p9-0a1-cli-boundary-extraction/plan.md
```
...
- **Plan**: docs/project-harness/tasks/p9-0a1-cli-boundary-extraction/plan.md
- **Phase**: approved
...
- **Start**: say you accepted `p9-0a1-cli-boundary-extraction` and list the 2-3 concrete steps you will do first.
...
```bash
assignment closeout discord-nexus --task-id p9-0a1-cli-boundary-extraction --reviewer <reviewer> \
...
- Primary: `/Users/yinxin/projects/multinexus` branch `agents/mac-omp/p9-0a1-cli-boundary-extraction`
...
3. For implementation tasks, run `assignment closeout discord-nexus --task-id p9-0a1-cli-boundary-extraction --reviewer <reviewer>`; do not mark your own implementation done
