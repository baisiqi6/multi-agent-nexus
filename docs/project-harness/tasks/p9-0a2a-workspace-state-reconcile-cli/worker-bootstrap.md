# Worker Bootstrap: p9-0a2a-workspace-state-reconcile-cli
...
Shared-worktree guard: this checkout may be used by other agents. If `pwd` is not `/Users/yinxin/projects/multinexus` or `git branch --show-current` is not `agents/mac-omp/p9-0a2a-workspace-state-reconcile-cli`, stop and report a blocker instead of switching branches.
...
```bash
cat docs/project-harness/tasks/p9-0a2a-workspace-state-reconcile-cli/plan.md
```
...
- **Task**: p9-0a2a-workspace-state-reconcile-cli
- **Title**: P9-0A2a Workspace State Reconcile CLI Extraction
- **Branch**: agents/mac-omp/p9-0a2a-workspace-state-reconcile-cli
- **Plan**: docs/project-harness/tasks/p9-0a2a-workspace-state-reconcile-cli/plan.md
- **Phase**: approved
...
- **Start**: say you accepted `p9-0a2a-workspace-state-reconcile-cli` and list the 2-3 concrete steps you will do first.
...
```bash
assignment closeout discord-nexus --task-id p9-0a2a-workspace-state-reconcile-cli --reviewer <reviewer> \
...
- Primary: `/Users/yinxin/projects/multinexus` branch `agents/mac-omp/p9-0a2a-workspace-state-reconcile-cli`
...
3. For implementation tasks, run `assignment closeout discord-nexus --task-id p9-0a2a-workspace-state-reconcile-cli --reviewer <reviewer>`; do not mark your own implementation done
