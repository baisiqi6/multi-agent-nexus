...
```text
[agent-report] action=progress workspace_id=multinexus task_id=phase-5.3-agent-registry-auto-sync summary="Completed <milestone>; tests: <result>; next: <next step>"
[agent-report] action=blocker workspace_id=multinexus task_id=phase-5.3-agent-registry-auto-sync reason="Need <decision/input>"
[agent-report] action=done workspace_id=multinexus task_id=phase-5.3-agent-registry-auto-sync summary="Implemented <scope>; tests: <result>; risks: <risk-or-none>"
```
