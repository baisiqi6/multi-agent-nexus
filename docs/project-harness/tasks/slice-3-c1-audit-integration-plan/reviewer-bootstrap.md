# Reviewer Bootstrap: slice-3-c1-audit-integration-plan
...
cat openspec/changes/slice-3-c1-audit-integration-plan/proposal.md
# also review: design.md, specs/*/spec.md, tasks.md in that dir,
# and any docs/superpowers/plans/*-slice-3-c1-audit-integration-plan*.md implementation plan
```

Control-plane recorded the plan at `docs/project-harness/tasks/slice-3-c1-audit-integration-plan/plan.md` (server path, for reference only — read your LOCAL repo, not the server path). Do NOT switch branches, create worktrees, or modify any file — plan review is strictly read-only.
...
- **Source Plan**: openspec/changes/slice-3-c1-audit-integration-plan/proposal.md (relative; server copy: docs/project-harness/tasks/slice-3-c1-audit-integration-plan/plan.md)
