# Worker Bootstrap: slice-3-c1-audit-integration-plan
...
```bash
cat docs/project-harness/tasks/slice-3-c1-audit-integration-plan/plan.md
```
...
- **Title**: S3-C1 Durable Audit And Integration Plan
- **Branch**: feature/multi-bot
- **Plan**: docs/project-harness/tasks/slice-3-c1-audit-integration-plan/plan.md
- **Phase**: approved
...
- **Start**: say you accepted `slice-3-c1-audit-integration-plan` and list the 2-3 concrete steps you will do first.
...
```bash
assignment closeout discord-nexus --task-id slice-3-c1-audit-integration-plan --reviewer <reviewer> \
...
3. For implementation tasks, run `assignment closeout discord-nexus --task-id slice-3-c1-audit-integration-plan --reviewer <reviewer>`; do not mark your own implementation done
