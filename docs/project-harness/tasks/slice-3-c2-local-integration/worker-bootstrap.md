# Worker Bootstrap: slice-3-c2-local-integration
...
```bash
cat docs/project-harness/tasks/slice-3-c2-local-integration/plan.md
```
...
- **Plan**: docs/project-harness/tasks/slice-3-c2-local-integration/plan.md
- **Phase**: approved
...
- **Start**: say you accepted `slice-3-c2-local-integration` and list the 2-3 concrete steps you will do first.
...
```bash
assignment closeout discord-nexus --task-id slice-3-c2-local-integration --reviewer <reviewer> \
...
3. For implementation tasks, run `assignment closeout discord-nexus --task-id slice-3-c2-local-integration --reviewer <reviewer>`; do not mark your own implementation done
